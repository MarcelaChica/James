                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="terms">
                            ...
                            <label for="terms">Al aceptar das expresamente consentimiento al tratamiento de sus datos personales. He leido y acepto la <a href="#" targer="_blank">Política de Tratamiento de datos </a></label>
                        </div>
