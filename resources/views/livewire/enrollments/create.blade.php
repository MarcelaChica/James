    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel">Crear nueva matricula</h5>
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="id_package" type="text" class="form-control" id="id_package" placeholder="Id Package">@error('id_package') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input wire:model="num_class" type="text" class="form-control" id="num_class" placeholder="Num Class">@error('num_class') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
